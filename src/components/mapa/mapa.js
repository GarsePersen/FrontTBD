...
export default {
  data() {
    return {
      ...
      selectedBool: false,
      bandas: [],
      regionSelected: "Información General",
      info1: "",
      info2: "",
      generos: [],
      geostatistics: [],
  ...
  methods: {
    mapPressed(region) {
      ...
      if (region == "I") {
        ...
        this.info1 = "Cantidad de tweets de la región analizados: " + this.regionI;

      }
      if (region == "II") {
        this.regionSelected = "Región de Antofagasta";
        this.info1 = "Cantidad de tweets de la región analizados: " + this.regionII;
      }
      if (region == "III") {
        this.regionSelected = "Región de Atacama";
        this.info1 = "Cantidad de tweets de la región analizados: " + this.regionIII;
      }
      if (region == "IV") {
        this.regionSelected = "Región de Coquimbo";
        this.info1 = "Cantidad de tweets de la región analizados: " + this.regionIV;
      }
      if (region == "V") {
        this.regionSelected = "Región de Valparaíso";
        this.info1 = "Cantidad de tweets de la región analizados: " + this.regionV;
      }
      if (region == "VI") {
        this.regionSelected = "Región de O'Higgins";
        this.info1 = "Cantidad de tweets de la región analizados: " + this.regionVI;
      }
      if (region == "Metropolitana") {
        this.regionSelected = "Región Metropolitana";
        this.info1 = "Cantidad de tweets de la región analizados: " + this.regionMet;
      }
      if (region == "VII") {
        this.regionSelected = "Región del Maule";
        this.info1 = "Cantidad de tweets de la región analizados: " + this.regionVII;
      }
      if (region == "VIII") {
        this.regionSelected = "Región del Bío Bío";
        this.info1 = "Cantidad de tweets de la región analizados: " + this.regionVIII;
      }
      if (region == "IX") {
        this.regionSelected = "Región de la Araucanía";
        this.info1 = "Cantidad de tweets de la región analizados: " + this.regionIX;
      }
      if (region == "X") {
        this.regionSelected = "Región de los Lagos";
        this.info1 = "Cantidad de tweets de la región analizados: " + this.regionX;
      }
      if (region == "XI") {
        this.regionSelected = "Región de Aisén";
        this.info1 = "Cantidad de tweets de la región analizados: " + this.regionXI;
      }
      if (region == "XII") {
        this.regionSelected = "Región de Magallanes y Antártica";
        this.info1 = "Cantidad de tweets de la región analizados: " + this.regionXII;
      }
      if (region == "XIV") {
        this.regionSelected = "Región de los Ríos";
        this.info1 = "Cantidad de tweets de la región analizados: " + this.regionXIV;
      }
      if (region == "XV") {
        this.regionSelected = "Región de Arica y Parinacota";
        this.info1 = "Cantidad de tweets de la región analizados: " + this.regionXV;
      }
    },
    crearMapa() {
